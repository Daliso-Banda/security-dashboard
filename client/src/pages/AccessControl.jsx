...
export default function AccessControl() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f5f7fa', py: 8, px: 2, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <Paper elevation={6} sx={{ p: 5, borderRadius: 4, width: '100%', maxWidth: 800 }}>
        ...
        {status && (
          <Alert severity="info" sx={{ mt: 4, fontWeight: 500 }}>
            {status}
          </Alert>
        )}
      </Paper>
